...
class User:
    ...
    session_i_ds: Optional[List[str]]
    username: str
    ...
    def from_dict(obj: Any) -> 'User':
        ...
        session_i_ds = from_union([lambda x: from_list(from_str, x), from_none], obj.get("sessionIDs"))
        username = from_str(obj.get("username"))
        return User(error, id, created_by, created_date, last_modified_by, modified_date, disabled, email, first_name, last_name, password_hashed, session_i_ds, username)
    ...
    def to_dict(self) -> dict:
        ...
        result["sessionIDs"] = from_union([lambda x: from_list(from_str, x), from_none], self.session_i_ds)
